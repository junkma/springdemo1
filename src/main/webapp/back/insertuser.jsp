...
<script>
   ...
   $(function () {
       $("#loginname").blur(
           function () {
               $.get("checkuser1", "check=" + $("#loginname").val(), callback);
        ...
        $("#username").blur(
            function () {
                $.get("checkuser","check="+$("#username").val(),callback);
                function callback(data) {
                    $("#span2").html(data);
        ...
        $("#password").blur(
            function () {
                $.get("checkuser","check="+$("#password").val(),callback);
                function callback(data) {
                    $("#span3").html(data);
        ...
        $("#cpassword").blur(
            function () {
                ...
                $.get("checkuser","check="+$("#cpassword").val(),callback);
                function callback(data) {
                    $("#span4").html(data);
        ...
        $("#adress").blur(
            function () {
                $.get("checkuser","check="+$("#adress").val(),callback);
                function callback(data) {
                    $("#span5").html(data);

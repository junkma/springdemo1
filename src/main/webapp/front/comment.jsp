                    ...
                    <div >
                        <ul>
                            <c:forEach items="${cate.childname}" var="child">
                                <li><a href="productType?id=${child.id}" target="right" id="comment2" >${child.name}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
                </c:forEach>
            ...
            <table cellspacing="0" cellpadding="0" border="0px" width="100%" id="table1">
                ...
                <tr>
                    <td style="text-align: right">
                        ...
                        <a href="comment?pagenum=1">[首页]</a>&nbsp;&nbsp;<a href="comment?pagenum=${pageInfo.pageNum-1}">[上一页]</a>&nbsp;&nbsp;<a href="comment?pagenum=2">[2]</a>&nbsp;&nbsp;<a href="comment?pagenum=3">[3]</a>&nbsp;&nbsp;<a href="comment?page=${pageInfo.pageNum+1}">[下一页]</a>&nbsp;&nbsp;<a href="comment?page=${pageInfo.pages}">[尾页]</a>
                    </td>
                </tr>
            </table>
